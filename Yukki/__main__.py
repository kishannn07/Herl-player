...
async def help_button(client, query):
    home_match = re.match(r"help__home\((.+?)\)", query.data)
    mod_match = re.match(r"help__module\((.+?)\)", query.data)
    prev_match = re.match(r"help__prev\((.+?)\)", query.data)
    next_match = re.match(r"help__next\((.+?)\)", query.data)
    back_match = re.match(r"help__back", query.data)
    create_match = re.match(r"help__create", query.data)
